        ...
        <div className="mx-auto max-w-3xl px-6 lg:px-8">
          ...
          <ScrollReveal delay={100}>
            <p className="mt-8 text-lg leading-relaxed text-gray-600">
              We specialize in window washing, and we also offer power washing
              and gutter cleaning. We enjoy building relationships in our
              community and making sure our customers feel taken care of and
              happy with the final result.
            </p>
          </ScrollReveal>
          <ScrollReveal delay={200}>
            <p className="mt-8 text-lg leading-relaxed text-gray-600">
              Our focus is simple: do solid work, provide friendly service, and
              help your home or business look its best.
            </p>
          </ScrollReveal>
        </div>
      </section>
